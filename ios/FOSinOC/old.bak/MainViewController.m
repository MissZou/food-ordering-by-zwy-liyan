...
@property (strong,nonatomic)UIView *coverViewBlankArea;
...
//        [self.slideButtonView initSlideButtonAddTitle:self.catagory];
//        self.slideButtonView.delegate = self;
//    [self.scrollHeadView addSubview:self.slideButtonView];
...
- (IBAction)catagoryClicked:(id)sender {
    ...
    if (self.coverView == nil && self.catagoryView == nil) {
        self.coverView = [[UIView alloc]initWithFrame:CGRectMake(0, self.scrollHeadView.frame.size.height + self.scrollHeadView.frame.origin.y, self.view.frame.size.width, self.view.frame.size.height*0.45)];
        
        self.coverViewBlankArea = [[UIView alloc]initWithFrame:CGRectMake(0, self.coverView.frame.origin.y+ self.coverView.frame.size.height, self.view.frame.size.width, self.view.frame.size.height -self.coverView.frame.origin.y- self.coverView.frame.size.height )];
        self.coverViewBlankArea.backgroundColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:0.7];
